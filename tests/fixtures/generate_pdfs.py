"""Generate 3 diverse-topic test PDFs for cementic search quality testing.

Usage:
    python tests/fixtures/generate_pdfs.py

Generated PDFs:
    - cs_neural_nets.pdf  (neural networks / deep learning)
    - bio_cell.pdf        (cell biology / organelles)
    - hist_rome.pdf       (Roman Republic history)
"""
...
def main() -> None:
    ...
    print("\nDone. 3 PDFs generated in tests/fixtures/")
